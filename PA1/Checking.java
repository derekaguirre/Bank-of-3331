...
//Methods that perform operations
    ...
    public void inquireBalanceLog(double balanceIn, String firstName, String lastName)throws IOException, FileNotFoundException{
        try{
            FileWriter fr = new FileWriter("Log.txt", true);
    ...
    public void depositLog(double initial, String firstName, String lastName, double moneyInput, double endAmount) throws IOException, FileNotFoundException{
        try{
            FileWriter fr = new FileWriter("Log.txt", true);
    ...
    public void withdrawLog(double initial, String firstName, String lastName, double withdrawFunds, double endAmount) throws IOException, FileNotFoundException{
        try{
            FileWriter fr = new FileWriter("Log.txt", true);
    ...
    public void transferLog(double initialAmountFirst, double initialAmountSecond, String firstNameFirst, String lastNameFirst, String firstNameSecond, String lastNameSecond, double amountTransferred, double endAmountFirst, double endAmountSecond) throws IOException, FileNotFoundException{
        try{
            FileWriter fr = new FileWriter("Log.txt", true);
                        ...
                        switch (choice) {
                            ...
                            case 2:// Will send money from one person to another
                                ...
                                for (Checking whatever : bank) { //Verifies if the second user exists
                                    if (recipientAccNum == whatever.getAccountNumber() && recipientAccNum !=firstUser.getAccountNumber())
                                        secondUser = whatever;
                                }
                            ...
                            case 4:// Will withdraw money from a user's account
                                ...
                                initialBalance = firstUser.getStartingBalance();//Saves balance before transaction
                                firstUser.setStartingBalance(firstUser.withdrawFunction(firstUser.getStartingBalance(), withdrawAmount)); //Updates the user's balance
